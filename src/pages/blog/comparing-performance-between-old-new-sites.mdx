...
AstroJS is a huge part of the performance gain, but also reworking/optimizing the site using the latest recommendations, e.g. using `.webp` instead of `.jpg`, helped as well.

In any case, the numbers are just:

![WOW](/blog/comparing-performance-between-old-new-sites/wow.webp)
