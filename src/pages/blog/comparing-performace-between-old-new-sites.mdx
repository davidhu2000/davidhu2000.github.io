...
AstroJS is 100% a huge part of the performace gain, but also reworking / optimizing the site using the latest recommendations, e.g. using `.webp` instead of `.jpg`.
